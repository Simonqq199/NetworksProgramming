...
namespace N106.N21.ATCL_LAB03
{
    public partial class FormBai2 : Form
    {
        ...
        private void StartThread()
        {
            ...
            listview.Items.Add(new ListViewItem("Found new client. Listening..."));
            ...
            while (clientSocket.Connected)
            {
                ...
                if (bytesRecv == 0)
                {
                    ...
                    listview.Items.Add(new ListViewItem("Client has disconnected\n"));
                    break;
                }

                listview.Items.Add(new ListViewItem("Client said: " + text));
            }
            clientSocket.Close();
        }
    }
